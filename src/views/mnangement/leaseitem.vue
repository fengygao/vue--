<template>
  <div class="iscroll">
    ...
    <el-form
      ...
      style="width:100%;min-width:600px;max-height:82vh;overflow-y: scroll;"
    >
          ...
          <el-row :gutter="24" class="borbot">
            <el-col :span="12">
              <el-form-item label="租赁主体">
                <el-input type="text" v-model="form.cc" @click.native="cc"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="品牌">
                <el-input v-model="form.dd" @click.native="dd"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="24" class="borbot">
    ...
    <eldislog :data2="List1" @chooseTree="valInput1" :infoTit="titInfo1" :isshow.sync="isshow1"></eldislog>
    <eldislog :data2="List2" @chooseTree="valInput2" :infoTit="titInfo2" :isshow.sync="isshow2"></eldislog>
  </div>
</template>

<script>
import eldislog from "../../components/publicDialog";
export default {
  data() {
    return {
      titInfo1: {
